...
//		const LineString3D& _overwrite(Image& dst, int32 thickness, const Color& color, bool antialiased, bool isClosed) const;
		...
		const LineString3D& _draw(const Mat4x4& vp, const LineStyle& style, double thickness, const ColorF& color, bool isClosed) const;

		void _drawCatmullRom( const Mat4x4& vp,const LineStyle& style, double thickness, const ColorF& color, int32 interpolation, bool isClosed) const;
...
//		}
		...
		const LineString3D& draw(const Mat4x4 &vp, const ColorF& color = Palette::White) const;
		...
		void drawCatmullRom(const Mat4x4 &vp, const ColorF& color = Palette::White, int32 interpolation = 24) const;
